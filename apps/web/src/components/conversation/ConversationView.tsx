...
export const ConversationView: React.FC<ConversationViewProps> = ({
  ...
  const countMaxDepth = (node: Node): number => {
    ...
    return Math.max(...node.children.map(child => countMaxDepth(child)));
  };
      ...
      <div className="bg-white border-t border-surface-200 px-8 py-4">
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2 text-brand-500">
            ...
            <input
              ...
              placeholder="Ask a new question or continue exploring..."
              className="w-full bg-surface-50 border border-surface-200 rounded-xl pl-12 pr-24 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all"
            />
            <button
